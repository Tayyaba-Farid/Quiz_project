  ...
  let question3 = await inquirer.prompt([
    {
      ...
      type: "list",
      message:
        "Rishabh starts walking towards the west. After walking 70 m he turns to the left and walks 35 m straight. He turns left again and walks 30 m, again he turns to the left and walks a distance of 35 m. How far is he from the starting point?",
  ...
  let question4 = await inquirer.prompt([
    {
      ...
      type: "list",
      message:
        "The amount of time required by a storage device to retrieve data and programs is it: ",
